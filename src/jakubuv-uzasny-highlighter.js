...
function getNode(index, original, elementWindow) {
    ...
    while (block_index < data.length && node === null) {
        ...
        const previousSibling = data[block_index].node.previousSibling || data[block_index].node.parentElement.previousSibling
